...
if __name__ == "__main__":
    ...
    for i_episode in tqdm(range(NUM_EPISODES)):
        ...
        episodic_reward_change.append(ep_reward)
        ep_r_change = torch.mean(torch.stack(episodic_reward_change))
        log_dit = {"cum_reward": ep_reward}
        log_dit["avg_reward"] = ep_avg_reward
        log_dit["ep_cum_change"] = ep_r_change
        # print(
