...
if __name__ == "__main__":
    ######SLATEQ########
    with open(
        "../../pomdp_saved_models/observed_topic_slateq_1.0_42/logs_dict.pickle",
        "rb",
    ) as f:
        slate1 = pickle.load(f)

    print(type(slate1["session_length"]))

    value = sum(slate1["session_length"]) / len(slate1["session_length"])
    print(value * 4)
    # with open(
