...
DEVICE = "cpu"
print("DEVICE: ", DEVICE)
CRITIC_PATH = "src/saved_models/random_wa/04-08_21-20-06/critic_model.pt"
ACTOR_PATH = "src/saved_models/random_wa/04-08_21-20-06/actor_model.pt"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="/home/aayush/git/rl_recsys/src/saved_models/random_wa/04-08_21-20-06/_config.yaml",
    ...
    bf_agent = torch.load(CRITIC_PATH)
    bf_agent.eval()
